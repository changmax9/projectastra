...
export function AdminSidebar() {
  return (
    <aside className="border-b border-white/40 bg-white/38 text-astra-navy shadow-[20px_0_60px_-52px_rgba(6,18,37,0.55)] backdrop-blur-2xl lg:min-h-[calc(100vh-88px)] lg:w-64 lg:border-b-0 lg:border-r">
        ...
        {links.map((link) => {
          ...
          return (
            <Link
              key={link.href}
              href={link.href}
              className="flex shrink-0 items-center gap-2 rounded-full px-3 py-2 font-mono text-xs font-bold uppercase tracking-wide text-slate-600 transition hover:bg-white/70 hover:text-astra-navy"
            >
