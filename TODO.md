...
- [pending] P2: Add authenticated browser/E2E coverage for `/admin/pdfs`.
  Current smoke coverage verifies compile plus unauthenticated redirect. Add a seeded mock admin, uploaded PDF, import start/resume, inline draft display, save-as-draft, reject, and no-direct-publish checks.
